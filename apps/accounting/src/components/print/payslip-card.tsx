...
export function PayslipCard({ data }: { data: PayslipData }) {
	...
	return (
		<div
			className="w-full max-w-[21cm] mx-auto bg-white border border-black p-0 print:border-none print:shadow-none"
		...
		>
			...
			<div className="flex border-b border-black">
				<div className="w-24 px-2 py-1 border-r border-black font-semibold text-xs">
					Name:
				</div>
				<div className="flex-1 px-2 py-1 font-bold text-sm uppercase">
					{data.staffName}
				</div>
			</div>
			...
			{type !== "part_time_teaching" && (
				<>
					...
					<div className="flex text-xs">
						...
						<div className="w-32 px-2 py-1 border-r border-black font-semibold text-center">
							Used
						</div>
						<div className="flex-1 px-2 py-1"></div>
					</div>
					<div className="flex border-b border-black text-xs">
						<div className="w-48 px-2 py-1 border-r border-black">
							Sick Leave
						</div>
			...
			<div className="flex border-b border-black text-xs">
				<div className="w-48 px-2 py-1 border-r border-black">
					{type === "part_time_teaching" ? "Daily Salary Rate" : "Basic Salary"}
				</div>
				<div className="w-16 px-2 py-1 border-r border-black">Php</div>
				<div className="w-32 px-2 py-1 border-r border-black text-right">
					{type === "part_time_teaching"
						? formatCurrency(data.dailySalary)
			...
			{type !== "part_time_teaching" && (
				<div className="flex border-b border-black text-xs">
					...
					<div className="flex-1 px-2 py-1 text-right">
						{formatCurrency(data.halfSalary)}
					</div>
				</div>
			)}
			...
			{type === "non_teaching" && (
				<div className="flex border-b border-black text-xs">
					...
					<div className="w-16 px-2 py-1 border-r border-black">Php</div>
					<div className="flex-1 px-2 py-1 text-right">
						{formatCurrency(data.additionalPay)}
					</div>
				</div>
			)}
			...
			{(type === "teaching" || type === "non_teaching") && (
				<div className="flex border-b border-black text-xs">
					...
					<div className="w-16 px-2 py-1 border-r border-black">Php</div>
					<div className="flex-1 px-2 py-1 text-right">
						{formatCurrency(data.subjectOverload)}
					</div>
				</div>
			)}
			...
			{type === "non_teaching" && (
				<div className="flex border-b border-black text-xs">
					...
					<div className="w-16 px-2 py-1 border-r border-black">Php</div>
					<div className="flex-1 px-2 py-1 text-right">
						{formatCurrency(data.transpoAllowance)}
					</div>
				</div>
			)}
			...
			{type === "non_teaching" && (
				<div className="flex border-b border-black text-xs">
					...
					<div className="w-16 px-2 py-1 border-r border-black">Php</div>
					<div className="flex-1 px-2 py-1 text-right">
						{formatCurrency(data.holidayPay)}
					</div>
				</div>
			)}
			...
			{type === "non_teaching" && (
				<div className="flex border-b border-black text-xs">
					...
					<div className="w-16 px-2 py-1 border-r border-black">Php</div>
					<div className="flex-1 px-2 py-1 text-right">
						{formatCurrency(data.moderatorPay)}
					</div>
				</div>
			)}
			...
			{type === "teaching" && (
				<div className="flex border-b border-black text-xs">
					...
					<div className="w-16 px-2 py-1 border-r border-black">Php</div>
					<div className="flex-1 px-2 py-1 text-right">
						{formatCurrency(data.positionPay)}
					</div>
				</div>
			)}
			...
			{type === "teaching" && (
				<div className="flex border-b border-black text-xs">
					...
					<div className="w-16 px-2 py-1 border-r border-black">Php</div>
					<div className="flex-1 px-2 py-1 text-right">
						{formatCurrency(data.advisoryPay)}
					</div>
				</div>
			)}

			<div className="flex border-b border-black text-xs font-bold">
				<div className="w-[18rem] px-2 py-1 border-r border-black">
					Total Income
				</div>
				<div className="flex-1 px-2 py-1 text-right">
			...
			{type !== "part_time_teaching" && (
				<>
					...
					<div className="flex border-b border-black text-xs">
						<div className="w-48 px-2 py-1 border-r border-black font-semibold">
							Fringe Benefits
						</div>
						<div className="w-16 px-2 py-1 border-r border-black"></div>
						<div className="w-32 px-2 py-1 border-r border-black"></div>
					...
					<div className="flex border-b border-black text-xs">
						...
						<div className="w-16 px-2 py-1 border-r border-black">Php</div>
						<div className="flex-1 px-2 py-1 text-right">
							{formatCurrency(data.philhealthEe)}
						</div>
					</div>
					<div className="flex border-b border-black text-xs">
			...
			<div className="px-4 py-4 space-y-6 text-[11px]">
				<div className="grid grid-cols-2 gap-8">
					<div>
						...
						<div className="border-b border-black w-48 font-bold">
							MICHELLE V. TALABONG
						</div>
