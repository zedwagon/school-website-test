...
import { updateSectionSubject } from "@school/api/sections/action";
...
export default function EditSubjectDialog({
  ...
  useEffect(() => {
    if (sectionSubject) {
      setTeacherId(sectionSubject.teacherId?.toString() || "");
      setDayOfWeek(sectionSubject.dayOfWeek || "");
      setStartTime(sectionSubject.startTime || "");
      setEndTime(sectionSubject.endTime || "");
    }
  }, [sectionSubject]);
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    startTransition(async () => {
      const res = await updateSectionSubject(sectionSubject.id, {
              ...
              <div>
                ...
                >
                  {selectedTeacher ? (
                    ...
                    <span className="text-gray-500">Assign Teacher</span>
                  )}
