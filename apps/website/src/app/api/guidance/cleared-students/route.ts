...
import { getClearedGuidance } from "@school/api/guidance/query";
...
export async function GET(request: NextRequest) {
  try {
    ...
    const result = await getClearedGuidance(search, gradeLevel);
    ...
    console.error("API Error (getClearedGuidance):", error);
    return NextResponse.json(
