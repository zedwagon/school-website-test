import { getClearedPayments } from "@school/api/accounting/query";
...
export async function GET(request: NextRequest) {
  try {
    ...
    const result = await getClearedPayments(search, gradeLevel);
    ...
    console.error("API Error (getClearedPayments):", error);
    return NextResponse.json(
