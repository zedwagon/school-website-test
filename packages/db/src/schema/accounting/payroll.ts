...
export const employeeContracts = accountingSchema.table("employee_contracts", {
	...
	baseSalary: numeric("base_salary", { precision: 10, scale: 2 })
		.default("0")
		.notNull(),
	transpoAllowance: numeric("transpo_allowance", { precision: 10, scale: 2 })
		.default("0")
		.notNull(),
	positionPay: numeric("position_pay", { precision: 10, scale: 2 })
		.default("0")
		.notNull(),
	advisoryPay: numeric("advisory_pay", { precision: 10, scale: 2 })
		.default("0")
		.notNull(),
	holidayPay: numeric("holiday_pay", { precision: 10, scale: 2 })
		.default("0")
		.notNull(),
	additionalPay: numeric("additional_pay", { precision: 10, scale: 2 })
		.default("0")
		.notNull(),
	moderatorPay: numeric("moderator_pay", { precision: 10, scale: 2 })
		.default("0")
		.notNull(),
	dailySalary: numeric("daily_salary", { precision: 10, scale: 2 })
		.default("0")
		.notNull(),
	subjectHoursPerDay: numeric("subject_hours_per_day", {
		precision: 10,
		scale: 2,
	})
		.default("0")
	...
	philhealthEe: numeric("philhealth_ee", { precision: 10, scale: 2 })
		.default("0")
		.notNull(),
	philhealthEr: numeric("philhealth_er", { precision: 10, scale: 2 })
		.default("0")
		.notNull(),
	pagIbigEe: numeric("pag_ibig_ee", { precision: 10, scale: 2 })
		.default("0")
		.notNull(),
	pagIbigEr: numeric("pag_ibig_er", { precision: 10, scale: 2 })
		.default("0")
		.notNull(),
...
export const payrolls = accountingSchema.table("payrolls", {
	...
	baseSalary: numeric("base_salary", { precision: 10, scale: 2 })
		.default("0")
		.notNull(),
	halfSalary: numeric("half_salary", { precision: 10, scale: 2 })
		.default("0")
		.notNull(), // Usually baseSalary / 2
	transpoAllowance: numeric("transpo_allowance", { precision: 10, scale: 2 })
		.default("0")
		.notNull(),
	positionPay: numeric("position_pay", { precision: 10, scale: 2 })
	...
	holidayPay: numeric("holiday_pay", { precision: 10, scale: 2 })
		.default("0")
		.notNull(),
	subjectOverload: numeric("subject_overload", { precision: 10, scale: 2 })
		.default("0")
		.notNull(),
	additionalPay: numeric("additional_pay", { precision: 10, scale: 2 })
		.default("0")
	...
	loanDeduction: numeric("loan_deduction", { precision: 10, scale: 2 })
		.default("0")
		.notNull(),
	totalDeductions: numeric("total_deductions", { precision: 10, scale: 2 })
		.default("0")
		.notNull(),
